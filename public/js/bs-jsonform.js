        ...
        switch (json.field.type) {
            ...
            case "select":
                ...
                <div class="`+spacer_class+`">
                    `+label+`   
                    <select class="form-select `+sizeClass+`" id="`+id+`">    
                `
            ...
            case "color":
                ...
                <div class="form-group `+spacer_class+`">
                    `+label+`
                    <input type="`+json.field.type+`" class="form-control form-control-color `+sizeClass+`" id="`+id+`" placeholder="`+json.field.placeholder+`" value="`+json.field.default_value+`">
                </div>
                </div>
                `
                break
